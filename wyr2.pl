...
Readonly my $WATSON => {
    organization     => 'spd010273',
    credentials_name => 'slack_dev',
    space            => 'dev_test',
};
...
Readonly my $SLACK_MAIN_CHANNEL => 'would_you_rather';
Readonly my $SLACK_ADMIN_CHANNEL => 'wyr_test';
...
sub _main()
{
    _init_slack( $SLACK_MAIN_CHANNEL, $SLACK_ADMIN_CHANNEL );
